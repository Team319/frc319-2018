...
public class MotionProfileExample {
	...
	private void startFilling(double[][] profile, int totalCnt) {
		...
		for (int i = 0; i < totalCnt; ++i) {
			...
			point.position = profile[i][0];// positionRot * Constants.kSensorUnitsPerRotation; //Convert Revolutions to
											// Units
			point.velocity = profile[i][1];// velocityRPM * Constants.kSensorUnitsPerRotation / 600.0; //Convert RPM to
											// Units/100ms
