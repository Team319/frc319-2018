...
/**
 * A command to drive in a straight line using WPI_VictorSPXs in PercentOutput Mode.
 ...
 */
public class CrossTheLine_WPI_VictorSPX extends Command {
	private WPI_VictorSPX _leftMotor;
	private WPI_VictorSPX _rightMotor;
    ...
    public CrossTheLine_WPI_VictorSPX(Subsystem requiredSubsystem, WPI_VictorSPX leftMotor, WPI_VictorSPX rightMotor, double percentOutput, double secondsToDrive, boolean reverseDirection) {
    ...
    public CrossTheLine_WPI_VictorSPX(Subsystem requiredSubsystem, int leftTalonCanId, int rightTalonCanId, double percentOutput, double secondsToDrive, boolean reverseDirection) {
        _leftMotor = new WPI_VictorSPX(leftTalonCanId);
        _rightMotor = new WPI_VictorSPX(rightTalonCanId);
        _setpoint = percentOutput;
        _timeoutSeconds = secondsToDrive;
        requires(requiredSubsystem);
    }
