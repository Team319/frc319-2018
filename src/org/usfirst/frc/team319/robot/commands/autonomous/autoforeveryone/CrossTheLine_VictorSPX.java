...
/**
 * A command to drive in a straight line using VictorSPXs in PercentOutput Mode.
 ...
 */
public class CrossTheLine_VictorSPX extends Command {
	private VictorSPX _leftMotor;
	private VictorSPX _rightMotor;
    ...
    public CrossTheLine_VictorSPX(Subsystem requiredSubsystem, VictorSPX leftMotor, VictorSPX rightMotor, double percentOutput, double secondsToDrive, boolean reverseDirection) {
    ...
    public CrossTheLine_VictorSPX(Subsystem requiredSubsystem, int leftTalonCanId, int rightTalonCanId, double percentOutput, double secondsToDrive, boolean reverseDirection) {
        _leftMotor = new VictorSPX(leftTalonCanId);
        _rightMotor = new VictorSPX(rightTalonCanId);
        _setpoint = percentOutput;
        _timeoutSeconds = secondsToDrive;
        requires(requiredSubsystem);
    }
