...
/**
 * A command to drive in a straight line using TalonSRXs in PercentOutput Mode.
 ...
 */
public class CrossTheLine_TalonSRX extends Command {
    ...
    public CrossTheLine_TalonSRX(Subsystem requiredSubsystem, TalonSRX leftMotor, TalonSRX rightMotor, double percentOutput, double secondsToDrive, boolean reverseDirection) {
    ...
    public CrossTheLine_TalonSRX(Subsystem requiredSubsystem, int leftTalonCanId, int rightTalonCanId, double percentOutput, double secondsToDrive, boolean reverseDirection) {
        _leftMotor = new TalonSRX(leftTalonCanId);
        _rightMotor = new TalonSRX(rightTalonCanId);
        _setpoint = percentOutput;
        _timeoutSeconds = secondsToDrive;
        requires(requiredSubsystem);
    }
