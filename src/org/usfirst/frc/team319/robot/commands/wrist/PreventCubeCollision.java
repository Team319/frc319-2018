 ...
 *
 */
public class PreventCubeCollision extends Command {

	boolean isSafe = false;
	private int safePosition = Robot.wrist.getSwitchPosition();
	private int switchPosition = Robot.wrist.getSwitchPosition();

	public PreventCubeCollision() {
