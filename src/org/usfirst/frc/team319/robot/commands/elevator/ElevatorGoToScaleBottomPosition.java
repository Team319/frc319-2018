 ...
 *
 */
public class ElevatorGoToScaleBottomPosition extends Command {

	private int targetPosition = Robot.elevator.getScaleBottomPosition();

	public ElevatorGoToScaleBottomPosition() {
