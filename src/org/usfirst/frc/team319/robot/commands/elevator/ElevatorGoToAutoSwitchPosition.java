 ...
 *
 */
public class ElevatorGoToAutoSwitchPosition extends Command {

	private int targetPosition = Robot.elevator.getAutoSwitchPosition();

	public ElevatorGoToAutoSwitchPosition() {
