...
public class Drivetrain extends Subsystem {
	...
	private int[] leftFollowers = {7}; //9
	private int[] rightFollowers = {2}; // 0
	StringBuilder _sb = new StringBuilder();
	private static int _loops = 0;
	
    public LeaderBobTalonSRX leftLead = new LeaderBobTalonSRX(6, leftFollowers); // 8
    public LeaderBobTalonSRX rightLead = new LeaderBobTalonSRX(1, rightFollowers); // 1
    //775 drivetrain code
